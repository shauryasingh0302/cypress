        ...
        <>
            <section className="overflow-hidden px-4 sm:px-6 mt-10 sm:flex sm:flex-col gap-4 md:justify-center md:items-center">
                ...
                <div className="bg-white p-0.5 mt-6 rounded-3xl bg-linear-to-r from-primary to-brand-primary-blue sm:w-75">
                    <Button variant="secondary" className="w-full rounded-3xl p-6 text-2xl bg-background">
                        Get Cypress Free
                    </Button>
                </div>

                <div className="md:-mt-[22.5px] sm:w-full w-[187.5px] flex justify-center items-center -mt-10 relative sm:ml-0 -ml-[12.5px]">
            ...
            <section className="relative">
                <div
                    className="overflow-hidden flex
                        ...
                        before:bg-gradient-to-r before:left-0 before:top-0 before:bottom-0 before:w-20 before:z-10 before:absolute"
                >
                    {[...Array(2)].map((_, index) => (
                        ...
                        <div
                            ...
                            className={twMerge(
                                clsx("mt-10 flex flex-nowrap gap-6 self-start", {
                                    ...
                                    "[animation-direction:reverse]": index === 1,
                                    "ml-[100vw]": index === 1,
                                }),
                                "paused-on-hover",
                            )}
            ...
            <section className="mt-20 px-4 sm:px-6 relative">
                <div className="w-full blur-[120px] rounded-full h-32 absolute bg-brand-primary-blue/20 -z-10 top-1/2 -translate-y-1/2" />
                <TitleSection
                ...
                <div className="flex flex-col-reverse sm:flex-row gap-4 justify-center sm:items-stretch items-center mt-10">
                    {PRICING_CARDS.map((card) => (
                        <CustomCard
                            key={card.planType}
                            className={clsx("w-[300px] rounded-2xl dark:bg-black/60 backdrop-blur-3xl relative", {
                            ...
                            cardHeader={
                                <CardTitle className="text-2xl font-semibold">
                                    {card.planType === PRICING_PLANS.proplan && (
                                        <>
                                            <div className="hidden dark:block w-full blur-[120px] rounded-full h-32 absolute bg-brand-primary-purple/80 -z-10 top-0" />
